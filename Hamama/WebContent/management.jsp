...
<button class="buttonClass" style="margin-top: 30px" onclick="location.href='http://localhost:8080/registration.jsp'">רשום משתמש חדש</button>
<button class="buttonClass" onclick="location.href='http://localhost:8080/remove.jsp'">הסר משתמש רשום</button>
